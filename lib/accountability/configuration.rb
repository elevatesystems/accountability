module Accountability
  class Configuration
    class << self
      attr_accessor :logo_path, :payment_gateway, :dev_tools_enabled, :automatic_billing_enabled, :country_whitelist
      ...
      def automatic_billing_enabled?
        !!automatic_billing_enabled
      end
    end
  end
end
